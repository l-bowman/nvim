      ...
      wk.add({
        {
          ...
          { "<leader>nf", "<cmd>lua FindNotesFiles()<cr>", desc = "Find Notes Files" },
          { "<leader>ng", "<cmd>lua LiveGrepNotes()<cr>", desc = "Grep Notes" },
          { "<leader>nn", "<cmd>lua EditNote('unsorted.md')<cr>", desc = "New Unsorted Note" },
          { "<leader>nu", "<cmd>lua StageCommitPushNotes()<cr>", desc = "Backup Notes" },
          { "<leader>np", "<cmd>lua PullNotes()<cr>", desc = "Pull Notes" },
          { "<leader>nt", "<cmd>lua EditNote('todo.md')<cr>", desc = "New Todo" },
          { "<leader>ns", "<cmd>lua EditNote('scratchpad.md')<cr>", desc = "Scratchpad" },
          { "<leader>o", group = "Octo" },
